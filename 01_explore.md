...
```
  //Explain
   ...
   - ราคาของรถที่ได้จากการคำนวณโดยแปลงเป็นค่าเงินของอังกฤษ คือ 189,000 ปอนด์ จะต้องนำไปคูณกับค่าเงินที่เป็นอัตราการแลกเปลี่ยนจะได้ ```189000 * 46.17 = 8,726,130 ```
...
### 7) รถที่ราคาต่ำสุดในการขับเคลื่อนของล้อแต่ละแบบและความเร็วเป็นเท่าใด
```{R}
